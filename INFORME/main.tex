...
\newcommand{\tituloTP}{Digit Recognizer}
\newcommand{\nroTP}{}
\newcommand{\codigoMateria}{75.06.56}
\newcommand{\nombreMateria}{Organización de Datos}
\newcommand{\departamento}{}

% Cosas para la caratula
\newcommand{\txtFacultad}{\Large{\textsc{\facultad}}}
\newcommand{\txtNombreTP}{\nroTP}
...
\newcommand{\txtAutores}{
	...
	\begin{tabbing}
		...
		Blanco, Joaquín  \\
		\> Padrón 94653 -\> \textit{E-mail:} joaquinbf@live.com\\[.3cm]
		Apellido, Nombre  \\
...
%					\def\svgwidth{\pagewidth}
  ...
  \tableofcontents
	%se puede escribir directamente aca pero prefiero que cada cual trabaje en un capitulo distinto
	\include{contenido}
